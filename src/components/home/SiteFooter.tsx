...
export function SiteFooter() {
  return (
    <footer className="relative z-20 mx-auto mt-12 w-full max-w-6xl border-t border-white/[0.08] pt-6 text-center">
      <p className="text-[11px] leading-relaxed text-white/30">
        Not affiliated with Valve or Steam. Public profiles only - Lifetime
